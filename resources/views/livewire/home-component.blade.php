                    ...
                    <div class="col-md-12">
                        <ul id="sponsors" class="tooltip-hover">
                            <li data-toggle="tooltip" title="" data-original-title="AC"> <a
                                    href="servicesbycategory/1.html"><img src="{{ asset('images/sercat/1521969345.png') }}"
                                        alt="AC"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Beauty"> <a
                                    href="servicesbycategory/2.html"><img src="{{ asset('images/sercat/1521969358.png') }}"
                                        alt="Beauty"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Plumbing"> <a
                                    href="servicesbycategory/3.html"><img src="{{ asset('images/sercat/1521969409.png') }}"
                                        alt="Plumbing"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Electrical"> <a
                                    href="servicesbycategory/4.html"><img src="{{ asset('images/sercat/1521969419.png') }}"
                                        alt="Electrical"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Shower Filter"> <a
                                    href="servicesbycategory/5.html"><img src="{{ asset('images/sercat/1521969430.png') }}"
                                        alt="Shower Filter"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Home Cleaning"> <a
                                    href="servicesbycategory/6.html"><img src="{{ asset('images/sercat/1521969446.png') }}"
                                        alt="Home Cleaning"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Carpentry"> <a
                                    href="servicesbycategory/7.html"><img src="{{ asset('images/sercat/1521969454.png') }}"
                                        alt="Carpentry"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Pest Control"> <a
                                    href="servicesbycategory/8.html"><img src="{{ asset('images/sercat/1521969464.png') }}"
                                        alt="Pest Control"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Chimney Hob"> <a
                                    href="servicesbycategory/9.html"><img src="{{ asset('images/sercat/1521969490.png') }}"
                                        alt="Chimney Hob"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Water Purifier"> <a
                                    href="servicesbycategory/10.html"><img src="{{ asset('images/sercat/1521969512.png') }}"
                                        alt="Water Purifier"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Computer Repair"> <a
                                    href="servicesbycategory/11.html"><img src="{{ asset('images/sercat/1521969522.png') }}"
                                        alt="Computer Repair"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="TV"> <a
                                    href="servicesbycategory/12.html"><img src="{{ asset('images/sercat/1521969536.png') }}"
                                        alt="TV"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Refrigerator"> <a
                                    href="servicesbycategory/13.html"><img src="{{ asset('images/sercat/1521969558.png') }}"
                                        alt="Refrigerator"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Geyser"> <a
                                    href="servicesbycategory/14.html"><img src="{{ asset('images/sercat/1521969576.png') }}"
                                        alt="Geyser"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Car"> <a
                                    href="servicesbycategory/15.html"><img src="{{ asset('images/sercat/1521969599.png') }}"
                                        alt="Car"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Document"> <a
                                    href="servicesbycategory/16.html"><img src="{{ asset('images/sercat/1521969622.png') }}"
                                        alt="Document"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Movers &amp; Packers"> <a
                                    href="servicesbycategory/17.html"><img src="{{ asset('images/sercat/1521972643.png') }}"
                                        alt="Movers &amp; Packers"></a></li>
                            <li data-toggle="tooltip" title="" data-original-title="Home Automation"> <a
                                    href="servicesbycategory/18.html"><img src="{{ asset('images/sercat/1521972593.png') }}"
                    ...
                    <div class="portfolioContainer" style="margin-top: -50px;">
                        <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            ...
                            <a class="g-list" href="service-details/ac-dry-servicing.html">
                                <div class="img-hover">
                                    <img src="{{ asset('images/services/thumbnails/images.jpg') }}" alt="AC Dry Servicing"
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                            ...
                            <a class="g-list" href="service-details/ac-installation.html">
                                <div class="img-hover">
                                    <img src="{{ asset('images/services/thumbnails/Install.jpg') }}" alt="AC Installation"
                                        class="img-responsive">
                                </div>
                                <div class="info-gallery">
            ...
            <div id="boxes-carousel">
                <div>
                    <a class="g-list" href="service-details/ac-wet-servicing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/Gas.jpeg') }}" alt="" class="img-responsive">
                        </div>
                ...
                <div>
                    <a class="g-list" href="service-details/bedroom-deep-cleaning.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/bedroom-cleaning-.jpg') }}" alt="" class="img-responsive">
                        </div>
                ...
                <div>
                    <a class="g-list" href="service-details/dining-chair-shampooing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/Dining.jpg') }}" alt="" class="img-responsive">
                        </div>
                ...
                <div>
                    <a class="g-list" href="service-details/carpet-shampooing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/Carpet.jpg') }}" alt="" class="img-responsive">
                        </div>
                ...
                <div>
                    <a class="g-list" href="service-details/fabric-sofa-shampooing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/sofa.jpg') }}" alt="" class="img-responsive">
                        </div>
